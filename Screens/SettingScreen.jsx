    ...
    <SafeAreaView style={styles.container}>
      ...
      <View
        ...
        <View style={styles.inputContainer}>
          <TouchableOpacity>
            <Ionicons name="people-alt" size={24} color="#4A90E2" />
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.input}
            onPress={() => navigation.navigate('Profile')}>
            <Text style={styles.registext}>Profile</Text>
          </TouchableOpacity>
        </View>
        <View style={styles.inputContainer}>
          <TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            <Text style={styles.registext}>Account</Text>
          </TouchableOpacity>
        </View>
        <View style={styles.inputContainer}>
          <TouchableOpacity>
            <Ionicons name="notifications-active" size={24} color="#4A90E2" />
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.input}
            onPress={() => navigation.navigate('Moto')}>
            <Text style={styles.registext}>Notification</Text>
          </TouchableOpacity>
        </View>
      </View>
    </SafeAreaView>
